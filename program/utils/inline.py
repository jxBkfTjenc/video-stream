...
def stream_markup(user_id):
  buttons = [
    [
      ...
      InlineKeyboardButton(text="• Tutup", callback_data=f'set_close'),
    ],
  ]
  return buttons
...
def menu_markup(user_id):
  buttons = [
    ...
    [
      InlineKeyboardButton(text="🔙 Kembali", callback_data='stream_home_panel'),
    ]
  ]
  return buttons
...
back_mark = InlineKeyboardMarkup(
  [
    [
      InlineKeyboardButton(
        "🔙 Kembali", callback_data="stream_menu_panel"
      )
    ]
  ]
)
