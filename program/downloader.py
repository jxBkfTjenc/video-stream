...
async def song_downloader(_, message):
    ...
    m = await message.reply("🔎 sedang mencari lagu...")
    ydl_ops = {
    ...
    try:
        ...
        await m.edit("❌ lagu tidak ditemukan.\n\n» Beri saya nama lagu yang valid !")
        print(str(e))
        return
    ...
    try:
        ...
        for i in range(len(dur_arr) - 1, -1, -1):
            ...
            secmul *= 60
        await m.edit("📤 sedang mengupload lagu...")
        ...
        await m.edit("❌ error, tunggu pemilik bot memperbaiki")
        print(e)
    try:
...
async def video_downloader(_, message):
    ...
    await msg.edit("📤 sedang upload video...")
...
async def get_lyric_genius(_, message: Message):
    ...
    m = await message.reply_text("🔍 sedang mencari lyrics...")
    ...
    if result is None:
        return await m.edit("❌ `404` lyrics tidak ditemukan")
    xxx = f"""
**Title song:** {query}
